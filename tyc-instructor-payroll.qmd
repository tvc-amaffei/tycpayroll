...
# Add the final_pay column for events and corporate flat rates
...
combined_sv_w_pay <- combined_sv_w_pay |>
  mutate(final_pay = ifelse(service_type == "Events",
                            ...
                            final_pay)) |>
# Add the final_pay column for corporate rates
  mutate(final_pay = ifelse (grepl("^Corp",hourly_pay_rate.s),
                             (wl_calc_pay.s + wl_calc_pay.v) * 1.0,
                             final_pay))
```
